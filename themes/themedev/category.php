    ...
    <div class="container">
      <div class="hero-banner hero-banner--sm">
        <div class="hero-banner__content">
          <h1>Category: <span class="text-info"><?php single_cat_title(); ?></span></h1>
              ...
              <div class="thumb">
                ...
                <ul class="thumb-info">
                  <li>
                    ...
                    $author_name = ucfirst(get_the_author()); // Capitalize first letter
                    $author_url  = get_author_posts_url($author_id);
                    echo '<a href="' . esc_url($author_url) . '">' . esc_html($author_name) . '</a>';
                  ?></li>
                  <li><a href="#"><i class="ti-notepad"></i> <?php echo get_the_date(); ?></a></li>
                  <li><a href="#"><i class="ti-themify-favicon"></i><?php echo get_comments_number( $post->ID ) ?> Comments</a></li>
                </ul>
              </div>
